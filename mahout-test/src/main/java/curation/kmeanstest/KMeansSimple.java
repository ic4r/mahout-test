...
//	private static void initWithValue(int k, )
	...
	public static void main(String[] args) {
		...
		double[] vA = {0.1, 0.2, 0.3, 0.9, 0.4};
		double[] vB = {0.1, 0.2, 0.7, 0.8, 1.5};
		
		System.out.println(cosineSimilarity(vA, vB));
	}
}